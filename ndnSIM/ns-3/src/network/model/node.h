...
public:
  ...
  uint32_t GetX(int cnode) ;
  uint32_t GetY(int cnode) ;
  uint32_t GetSPEED(int cnode) ;
  uint32_t GetDIS(int cnode) ;
  uint32_t GetNUM(int cnode ) ;
  uint32_t GetD(int cnode) ;

  uint32_t SetX(uint32_t x,int cnode);
  uint32_t SetY(uint32_t y,int cnode);
  uint32_t SetSPEED(uint32_t speed,int cnode);
  uint32_t SetDIS(uint32_t dis,int cnode);
  uint32_t SetNUM(uint32_t num,int cnode);
  uint32_t SetD(uint32_t d,int cnode);
